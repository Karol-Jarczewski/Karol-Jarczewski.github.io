...
class Slider {
  ...
  create() {
    ...
    this.classNameActive = this.slider.test(typeof this.settings.activeClassName !== "string", new TypeError("Wartość właściwości activeClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.activeClassName), this.settings.activeClassName);
    this.classNamePrev = this.slider.test(typeof this.settings.prevClassName !== "string", new TypeError("Wartość właściwości prevClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.prevClassName), this.settings.prevClassName);
    this.classNameFirst = this.slider.test(typeof this.settings.firstClassName !== "string", new TypeError("Wartość właściwości firstClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.firstClassName), this.settings.firstClassName);
    this.classNameLoading = this.slider.test(typeof this.settings.loadingClassName !== "string", new TypeError("Wartość właściwości loadingClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.loadingClassName), this.settings.loadingClassName);
    this.classNameLoadError = this.slider.test(typeof this.settings.loadErrorClassName !== "string", new TypeError("Wartość właściwości loadErrorClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.loadErrorClassName), this.settings.loadErrorClassName);
    this.classNameLoaded = this.slider.test(typeof this.settings.loadedClassName !== "string", new TypeError("Wartość właściwości loadedClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.loadedClassName), this.settings.loadedClassName);
    this.classNameAnimation = this.slider.test(typeof this.settings.animation !== "string", new TypeError("Wartość właściwości animation nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.animation), this.settings.animation);
    this.classNameJS = this.slider.test(typeof this.settings.jsClassName !== "string", new TypeError("Wartość właściwości jsClassName nie jest ciągiem znaków, przekazana właściwość to: " + this.settings.jsClassName), this.settings.jsClassName);

    this.autoTime = this.slider.test(typeof this.settings.time !== "number", new TypeError("Wartość właściwości time nie jest liczbą, przekazana właściwość to: " + this.settings.time), this.settings.time);
  ...
  tryIndex(index) {
    if(typeof index !== "number") {
      throw new TypeError("funkcja tryIndex - Slide musi być liczbą: " + index);
    }
 ...
 animationTape(animation) {
  ...
  event() {
    ...
    if(this.eventElementNav) {
      if(this.eventElementNav.length !== this.slider.length) {
        throw new TypeError("Niewłaściwa ilość nawigacji: " + this.eventElementNav.length);
      }
  ...
  options(options) {
    Object.assign(this.settings, this.slider.test(typeof options !== "object", "Do klasy slider został przekazany argument niebędący obiektem, przekazany argument to: " + options, options));
    return this;
  }
